...
const Navbar = () => {
  ...
  return (
    <div className='z-[2] hover:opacity-100 h-7rem w-screen bottom-0 flex text-white fixed bg bg-altbackground md:font-body md:h-screen md:text-xl md:bg md:bg-background md:w-[1px] md:hover:w-80 md:transition-all md:duration-300 md:hover:bg-altbackground md:bottom-auto '>
      <ul className='flex md:flex-col w-full justify-between items-center md:h-full md:m-0 md:justify-start md:items-start'>
        <li className='md:my-5 md:px-5 md:w-80'>
        ...
        <li className='md:my-5 md:px-5 md:w-80'>
          <Link activeClass="active" to="experience" spy={true} smooth={true} offset={50} duration={500} className='w-full h-full group flex items-center md:hover:text-opacity-100 md:transition-opacity md:duration-300'>
            <svg className="w-10 h-10 md:w-20 md:h-20 m-2 opacity-40 group-hover:opacity-100 transition-opacity duration-300 transition transform hover:scale-105" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#ffffff" d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 320 512V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM512 288H320v32c0 17.7-14.3 32-32 32H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V288z" /></svg>
            <span className='md:block md:opacity-0 md:group-hover:opacity-100 md:transition-opacity md:duration-300 md:w-20 hidden ml-5'>My Journey</span>
          </Link>
        </li>
        <li className='md:my-5 md:px-5 md:w-80'>
              <Link activeClass="active" to="fun" spy={true} smooth={true} offset={50} duration={500}  className='w-full h-full group flex items-center md:hover:text-opacity-100 md:transition-opacity md:duration-300'>
              ...
              <span className='md:block md:opacity-0 md:group-hover:opacity-100 md:transition-opacity md:duration-300 md:w-20 hidden ml-5'>Projects</span>
              </Link>
            </li>
          <li className='md:my-5 md:px-5 md:w-80'>
            <Link activeClass="active" to="skills" spy={true} smooth={true} offset={50} duration={500} className='w-full h-full group flex items-center md:hover:text-opacity-100 md:transition-opacity md:duration-300'>
              <svg className="w-10 h-10 md:w-20 md:h-20 m-2 md:mt-0 opacity-40 group-hover:opacity-100 transition-opacity duration-300 transition transform hover:scale-105" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="#ffffff" d="M392.8 1.2c-17-4.9-34.7 5-39.6 22l-128 448c-4.9 17 5 34.7 22 39.6s34.7-5 39.6-22l128-448c4.9-17-5-34.7-22-39.6zm80.6 120.1c-12.5 12.5-12.5 32.8 0 45.3L562.7 256l-89.4 89.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l112-112c12.5-12.5 12.5-32.8 0-45.3l-112-112c-12.5-12.5-32.8-12.5-45.3 0zm-306.7 0c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3l112 112c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256l89.4-89.4c12.5-12.5 12.5-32.8 0-45.3z" /></svg>
              <span className='md:flex md:opacity-0 md:group-hover:opacity-100 md:transition-opacity md:duration-300 md:w-20 hidden ml-5'>Skills</span>              
              </Link>
          </li>
        <li className='hidden mt-auto md:block md:px-5 md:w-80'>
          <Link activeClass="active" to="title" spy={true} smooth={true} offset={50} duration={500} className='group flex items-center'>
